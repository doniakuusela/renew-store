    ...
    <main style={{fontFamily:'sans-serif', background:'#F5F0E8', minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center'}}>
      <div style={{background:'white', padding:'48px', borderRadius:'4px', width:'100%', maxWidth:'420px', boxShadow:'0 4px 24px rgba(0,0,0,0.08)'}}>
        <div style={{textAlign:'center', marginBottom:'32px'}}>
          <div onClick={() => window.location.href='/'} style={{fontSize:'22px', color:'#2D5A3D', fontWeight:'600', marginBottom:'8px', cursor:'pointer'}}>🌿 Renew Store</div>
          <h1 style={{fontSize:'28px', fontWeight:'600', fontFamily:'Georgia, serif', color:'#1E1E1E'}}>{isLogin ? 'Welcome back' : 'Create account'}</h1>
        </div>
        <button onClick={handleGoogle} style={{width:'100%', background:'white', border:'1.5px solid #D9CEBC', padding:'12px', color:'#1E1E1E', fontSize:'14px', cursor:'pointer', borderRadius:'2px', display:'flex', alignItems:'center', justifyContent:'center', gap:'10px', marginBottom:'20px', fontFamily:'sans-serif'}}>
        ...
        <div style={{marginBottom:'16px'}}>
          ...
          <input type="email" value={email} onChange={e => setEmail(e.target.value)}
            style={{width:'100%', border:'1.5px solid #D9CEBC', borderRadius:'2px', padding:'11px 14px', fontSize:'14px', outline:'none', boxSizing:'border-box', color:'#1E1E1E'}}
        ...
        <p style={{textAlign:'center', marginTop:'20px', fontSize:'13px', color:'#7A7068'}}>
          ...
          <button onClick={() => setIsLogin(!isLogin)} style={{background:'none', border:'none', color:'#2D5A3D', cursor:'pointer', fontWeight:'500'}}>
