  ...
  return (
    <main style={{fontFamily:'sans-serif', background:'#F5F0E8', minHeight:'100vh', paddingTop:'68px'}}>
      <nav style={{background:'rgba(245,240,232,0.95)', borderBottom:'1px solid #D9CEBC', padding:'0 5%', height:'68px', display:'flex', alignItems:'center', justifyContent:'space-between', position:'fixed', top:0, left:0, right:0, zIndex:100}}>
        ...
        <a href="/" style={{fontSize:'13px', color:'#4A4A4A', textDecoration:'none'}}>← Back</a>
      </nav>
      ...
      <div style={{maxWidth:'680px', margin:'0 auto', padding:'48px 8%'}}>
        ...
        <div style={{marginBottom:'20px'}}>
          <label style={{display:'block', fontSize:'11px', fontWeight:'600', textTransform:'uppercase', color:'#4A4A4A', marginBottom:'6px'}}>Photos * (max 5)</label>
          ...
          {imageUrls.length < 5 && (
            <label style={{display:'block', border:'2px dashed #D9CEBC', padding:'20px', textAlign:'center', cursor:'pointer', borderRadius:'4px', background:'white'}}>
              ...
              <p style={{fontSize:'13px', color:'#4A4A4A'}}>{uploading ? 'Uploading...' : `Click to add photo${imageUrls.length > 0 ? 's' : ''}`}</p>
              <p style={{fontSize:'11px', color:'#4A4A4A', marginTop:'4px'}}>JPG, PNG — max 5MB each · {5 - imageUrls.length} more allowed</p>
        ...
        <div style={{marginBottom:'20px'}}>
          <label style={{display:'block', fontSize:'11px', fontWeight:'600', textTransform:'uppercase', color:'#4A4A4A', marginBottom:'6px'}}>Title *</label>
        ...
        <div style={{marginBottom:'20px'}}>
          <label style={{display:'block', fontSize:'11px', fontWeight:'600', textTransform:'uppercase', color:'#4A4A4A', marginBottom:'6px'}}>Description</label>
        ...
        <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'16px', marginBottom:'20px'}}>
          <div>
            <label style={{display:'block', fontSize:'11px', fontWeight:'600', textTransform:'uppercase', color:'#4A4A4A', marginBottom:'6px'}}>Price (QAR) *</label>
          ...
          <div>
            <label style={{display:'block', fontSize:'11px', fontWeight:'600', textTransform:'uppercase', color:'#4A4A4A', marginBottom:'6px'}}>Category</label>
        ...
        <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'16px', marginBottom:'20px'}}>
          <div>
            <label style={{display:'block', fontSize:'11px', fontWeight:'600', textTransform:'uppercase', color:'#4A4A4A', marginBottom:'6px'}}>Condition</label>
          ...
          <div>
            <label style={{display:'block', fontSize:'11px', fontWeight:'600', textTransform:'uppercase', color:'#4A4A4A', marginBottom:'6px'}}>Location</label>
